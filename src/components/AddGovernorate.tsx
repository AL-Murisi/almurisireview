...
import { createGov, getGover, governorates } from "../libs/data";
    ...
    <main className="admin-page" dir="rtl">
      <div className="branch-toolbar">
        <div className="search-box">
          ...
          <input placeholder="بحث المحافظه" className="search-input"></input>
        </div>
        <Dialog
          isopen={isOpen}
          btn={
            ...
            {governorates.length === 0 ? (
              ...
              governorates.map((gover, key) => (
                <div key={key} className="branch-row">
                  ...
                  <div className="col-name">{gover.name}</div>
